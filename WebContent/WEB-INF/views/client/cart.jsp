                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="product-quantity"><input type="number" min="1" max="" class="amount" book_id="${data.book.id}" value="${data.amount}"></td>
                                            <td class="product-subtotal"><fmt:formatNumber currencyCode="vi_VN" value="${data.amount*data.book.price}" /> VND</td>
                                            <td class="product-remove"><a href="cart/delete/${data.id}.htm?book=${data.book.id}&num=${data.amount}">X</a></td>
                                        </tr>
                                        </c:forEach>
                                    </tbody>
                                </table>
                    ...
                    <div class="col-lg-6 offset-lg-6">
                        <div class="cartbox__total__area">
                            <div class="cart__total__amount">
                                <span>Total</span>
                                <span><fmt:formatNumber currencyCode="vi_VN" value="${total}" /> VND</span>
                            </div>
                            <div class="mt--40">
                            	 <a class="btn btn-success btn-lg btn-block" href="checkout.htm">
          							Checkout
        				   		</a>
                            </div>
                        </div>
